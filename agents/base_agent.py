"""
基础 Agent 模块
使用 LangChain 1.3.1 的全新 create_agent API 实现通用的智能体封装
...
技术要点：
- 使用 LangChain 1.3.1 的 langchain.agents.create_agent API
...
class BaseAgent:
    ...
    封装了 LangChain 1.3.1 的 create_agent 功能，提供统一的智能体接口。
